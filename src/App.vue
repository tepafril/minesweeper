...
export default defineComponent({
  ...
  methods: {
    ...
    play() {
      ...
      this.warScene
        ? this.gameManager.assets.audio.play()
        : (this.gameManager.assets.audio.pause(), (this.gameManager.assets.audio.currentTime = 0))
    },
  },
  mounted() {
...
<template>
  <div class="h-screen flex items-center justify-center">
    ...
    <div ref="container" class="w-[927px] h-[700px] border-[#af753b] border-[1px] absolute">
      <img
        class="absolute z-[100000] scale-[1.19]"
        :class="state == StateEnum.Ready ? 'cursor-pointer' : ''"
        draggable="false"
        dragstart="false"
      ...
      <div class="bord1er-[#412c17] bor1der-[8px]">
        <div class="bor1der-[#b78b2d] bo1rder-[4px]">
          <div class="overflow-hidden relative">
            <template v-if="state != StateEnum.InGame">
              <div
            ...
            <template v-else-if="state == StateEnum.InGame">
              <Board />
            </template>
          </div>
        </div>
